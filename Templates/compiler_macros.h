 ...
 *      Author: yriyk
 *      Общие макросы для работы библиотек SupportLibs
 *      Версия 1.00 beta built 001 от 12.11.2020
 *
 *      Для работы библиотек подмодуля SupportLibs необходимо объявить этот файл в main.h
 */
